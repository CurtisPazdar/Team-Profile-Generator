...
function nextChoice() {
  ...
  .prompt([
    {
        type: 'list',
        message: 'Please either add an intern, engineer, or complete building your team',
...
function fileEnd() {
    fs.appendFileSync("team.html",`<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js"
